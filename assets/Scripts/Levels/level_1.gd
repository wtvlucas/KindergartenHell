...
func _process(delta: float) -> void:
	...
	prints("total:",SaveSystem.get_total_stars(), "| level1:", SaveSystem.get_stars_for_level("level1"), "| level2:",SaveSystem.get_stars_for_level("level2"), "| level3: ",SaveSystem.get_stars_for_level("level3"), "| saved:", saved, "| stars:", stars, " | timeleft:", int(timer.time_left))
	...
	if SaveSystem.get_stars_for_level("level1") < stars:
		SaveSystem.set_stars_for_level("level1", stars)
